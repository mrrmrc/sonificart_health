// --- Self-contained Web Worker for heavy-duty block analysis ---
// This code runs in a separate thread and does not block the UI.

// --- Color utility functions (copied from colorUtils.ts) ---
...
function analyzeBlocksInWorker(imageData, pixelCount, imageBounds) {
...
self.onmessage = (e) => {
    ...
    const result = analyzeBlocksInWorker(imageData, pixelCount, imageBounds);
